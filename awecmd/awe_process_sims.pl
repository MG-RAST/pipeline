...
sub get_usage {
    return "USAGE: awe_process_sims.pl -input=<input sims> <-aa|-rna> [-output_prefix=<output prefix> -mem_host=<memcache host> -mem_key=<memcache key>]\n";
}
