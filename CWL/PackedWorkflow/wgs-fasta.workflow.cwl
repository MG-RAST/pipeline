{
    ...
    "$graph": [
        ...
        }, 
        {
            "class": "CommandLineTool", 
            "label": "filter fasta", 
            "doc": "filter fasta file based on sequence length and/or on number of ambiguity characters (Ns)\nskipping both filters is equivalent to copying the file, but slower\n", 
            "hints": [
                {
                    "dockerPull": "mgrast/pipeline:4.03", 
                    "class": "DockerRequirement"
            ...
            "inputs": [
                {
                    ...
                    "id": "#filter_fasta.tool.cwl/deviation"
                }, 
                {
                    "type": [
                        "null", 
                    ...
                    "id": "#filter_fasta.tool.cwl/filterAmbig"
                }, 
                {
                    "type": [
                        "null", 
                    ...
                    "id": "#filter_fasta.tool.cwl/filterLn"
                }, 
                {
                    "type": "File", 
                    "doc": "input fasta sequence file", 
                    "format": [
                        "#filter_fasta.tool.cwl/input/FileFormats.cv.yamlfasta"
                    ], 
                    "inputBinding": {
                        "prefix": "-input"
                    }, 
                    "id": "#filter_fasta.tool.cwl/input"
                }, 
                {
                    "type": [
                        "null", 
                    ...
                    "id": "#filter_fasta.tool.cwl/maxAmbig"
                }, 
                {
                    "type": "string", 
                    ...
                    "id": "#filter_fasta.tool.cwl/outPassed"
                }, 
                {
                    "type": "string", 
                    ...
                    "id": "#filter_fasta.tool.cwl/outRemoved"
                }, 
                {
                    "type": "File", 
        ...
        }, 
        {
            ...
            "inputs": [
                {
                    "type": "Directory", 
                    "id": "#organism-screening.workflow.cwl/indexDir"
                }, 
                {
                    "type": [
                        "null", 
                    ...
                    "default": "h_sapiens", 
                    "id": "#organism-screening.workflow.cwl/indexName"
                }, 
                {
                    "type": "string", 
                    "id": "#organism-screening.workflow.cwl/jobid"
                }, 
                {
                    "type": "File", 
                    "id": "#organism-screening.workflow.cwl/sequences"
                }
            ], 
            "outputs": [
                {
                    "type": "File", 
                    "outputSource": "#organism-screening.workflow.cwl/untruncateScreen/file", 
                    "id": "#organism-screening.workflow.cwl/passed"
                }
            ], 
            "steps": [
                {
                    ...
                    "in": [
                        {
                            "source": "#organism-screening.workflow.cwl/indexDir", 
                            "id": "#organism-screening.workflow.cwl/screen/indexDir"
                        }, 
                        {
                            "source": "#organism-screening.workflow.cwl/indexName", 
                            "id": "#organism-screening.workflow.cwl/screen/indexName"
                        }, 
                        {
                            "source": "#organism-screening.workflow.cwl/truncate/file", 
                            "valueFrom": "$(self.basename).unaligned", 
                            "id": "#organism-screening.workflow.cwl/screen/outUnaligned"
                        }, 
                        {
                            "source": "#organism-screening.workflow.cwl/truncate/file", 
                            "id": "#organism-screening.workflow.cwl/screen/sequences"
                        }
                    ], 
                    "out": [
                        "#organism-screening.workflow.cwl/screen/unaligned"
                    ], 
                    "id": "#organism-screening.workflow.cwl/screen"
                }, 
                {
                    "run": "#seqUtil.tool.cwl", 
                    "in": [
                        {
                            "source": "#organism-screening.workflow.cwl/sequences", 
                            "valueFrom": "$(self.basename).sort", 
                            "id": "#organism-screening.workflow.cwl/sortInput/output"
                        }, 
                        {
                            "source": "#organism-screening.workflow.cwl/sequences", 
                            "id": "#organism-screening.workflow.cwl/sortInput/sequences"
                        }, 
                        {
                            "default": true, 
                            "id": "#organism-screening.workflow.cwl/sortInput/sortbyid"
                        }
                    ], 
                    "out": [
                        "#organism-screening.workflow.cwl/sortInput/file"
                    ], 
                    "id": "#organism-screening.workflow.cwl/sortInput"
                }, 
                {
                    "run": "#seqUtil.tool.cwl", 
                    "in": [
                        {
                            "source": "#organism-screening.workflow.cwl/screen/unaligned", 
                            "valueFrom": "$(self.basename).ids", 
                            "id": "#organism-screening.workflow.cwl/sortScreenID/output"
                        }, 
                        {
                            "source": "#organism-screening.workflow.cwl/screen/unaligned", 
                            "id": "#organism-screening.workflow.cwl/sortScreenID/sequences"
                        }, 
                        {
                            "default": true, 
                            "id": "#organism-screening.workflow.cwl/sortScreenID/sortbyid2id"
                        }
                    ], 
                    "out": [
                        "#organism-screening.workflow.cwl/sortScreenID/file"
                    ], 
                    "id": "#organism-screening.workflow.cwl/sortScreenID"
                }, 
                {
                    "run": "#seqUtil.tool.cwl", 
                    "in": [
                        {
                            "default": true, 
                            "id": "#organism-screening.workflow.cwl/truncate/bowtieTruncate"
                        }, 
                        {
                            "source": "#organism-screening.workflow.cwl/sequences", 
                            "valueFrom": "$(self.basename).truncate", 
                            "id": "#organism-screening.workflow.cwl/truncate/output"
                        }, 
                        {
                            "source": "#organism-screening.workflow.cwl/sequences", 
                            "id": "#organism-screening.workflow.cwl/truncate/sequences"
                        }
                    ], 
                    "out": [
                        "#organism-screening.workflow.cwl/truncate/file"
                    ], 
                    "id": "#organism-screening.workflow.cwl/truncate"
                }, 
                {
                    "run": "#seqUtil.tool.cwl", 
                    "in": [
                        {
                            "source": "#organism-screening.workflow.cwl/jobid", 
                            "valueFrom": "$(self).299.screen.passed.fna", 
                            "id": "#organism-screening.workflow.cwl/untruncateScreen/output"
                        }, 
                        {
                            "source": "#organism-screening.workflow.cwl/sortInput/file", 
                            "id": "#organism-screening.workflow.cwl/untruncateScreen/sequences"
                        }, 
                        {
                            "source": "#organism-screening.workflow.cwl/sortScreenID/file", 
                            "id": "#organism-screening.workflow.cwl/untruncateScreen/subsetList"
                        }, 
                        {
                            "default": true, 
                            "id": "#organism-screening.workflow.cwl/untruncateScreen/subsetSeqs"
                        }
                    ], 
                    "out": [
                        "#organism-screening.workflow.cwl/untruncateScreen/file"
                    ], 
                    "id": "#organism-screening.workflow.cwl/untruncateScreen"
                }
            ], 
            "id": "#organism-screening.workflow.cwl"
        }, 
        {
            "class": "Workflow", 
            "label": "preprocess fasta", 
            "doc": "Remove reads from fasta files based on sequence stats.\nReturn fasta files with reads passed and reads removed.\n", 
            "requirements": [
                {
                    "class": "StepInputExpressionRequirement"
                }, 
            ...
            "inputs": [
                {
                    "type": "float", 
                    "default": 2.0, 
                    "id": "#preprocess-fasta.workflow.cwl/deviation"
                }, 
                {
                    "type": "boolean", 
                    "default": true, 
                    "id": "#preprocess-fasta.workflow.cwl/filterAmbig"
                }, 
                {
                    "type": "boolean", 
                    "default": true, 
                    "id": "#preprocess-fasta.workflow.cwl/filterLn"
                }, 
                {
                    "type": "string", 
                    "id": "#preprocess-fasta.workflow.cwl/jobid"
                }, 
                {
                    "type": "int", 
                    "default": 5, 
                    "id": "#preprocess-fasta.workflow.cwl/maxAmbig"
                }, 
                {
                    "type": "File", 
                    "id": "#preprocess-fasta.workflow.cwl/sequences"
                }, 
                {
                    "type": "File", 
                    "id": "#preprocess-fasta.workflow.cwl/stats"
                }
            ], 
            "outputs": [
                {
                    "type": "File", 
                    "outputSource": "#preprocess-fasta.workflow.cwl/filter/passed", 
                    "id": "#preprocess-fasta.workflow.cwl/passed"
                }, 
                {
                    "type": "File", 
                    "outputSource": "#preprocess-fasta.workflow.cwl/filter/removed", 
                    "id": "#preprocess-fasta.workflow.cwl/removed"
                }, 
                {
                    "type": "File", 
                    "outputSource": "#preprocess-fasta.workflow.cwl/adapterTrim/outTrim", 
                    "id": "#preprocess-fasta.workflow.cwl/trimmed"
                }
            ], 
            "steps": [
                {
                    ...
                    "in": [
                        {
                            "source": "#preprocess-fasta.workflow.cwl/sequences", 
                            "id": "#preprocess-fasta.workflow.cwl/adapterTrim/input"
                        }, 
                        {
                            "source": "#preprocess-fasta.workflow.cwl/jobid", 
                            "valueFrom": "$(self).080.adapter.trim.passed.fna", 
                            "id": "#preprocess-fasta.workflow.cwl/adapterTrim/outName"
                        }
                    ], 
                    "out": [
                        "#preprocess-fasta.workflow.cwl/adapterTrim/outTrim"
                    ], 
                    "id": "#preprocess-fasta.workflow.cwl/adapterTrim"
                }, 
                {
                    "run": "#filter_fasta.tool.cwl", 
                    "in": [
                        {
                            "source": "#preprocess-fasta.workflow.cwl/deviation", 
                            "id": "#preprocess-fasta.workflow.cwl/filter/deviation"
                        }, 
                        {
                            "source": "#preprocess-fasta.workflow.cwl/filterAmbig", 
                            "id": "#preprocess-fasta.workflow.cwl/filter/filterAmbig"
                        }, 
                        {
                            "source": "#preprocess-fasta.workflow.cwl/filterLn", 
                            "id": "#preprocess-fasta.workflow.cwl/filter/filterLn"
                        }, 
                        {
                            "source": "#preprocess-fasta.workflow.cwl/adapterTrim/outTrim", 
                            "id": "#preprocess-fasta.workflow.cwl/filter/input"
                        }, 
                        {
                            "source": "#preprocess-fasta.workflow.cwl/maxAmbig", 
                            "id": "#preprocess-fasta.workflow.cwl/filter/maxAmbig"
                        }, 
                        {
                            "source": "#preprocess-fasta.workflow.cwl/jobid", 
                            "valueFrom": "$(self).100.preprocess.passed.fna", 
                            "id": "#preprocess-fasta.workflow.cwl/filter/outPassed"
                        }, 
                        {
                            "source": "#preprocess-fasta.workflow.cwl/jobid", 
                            "valueFrom": "$(self).100.preprocess.removed.fna", 
                            "id": "#preprocess-fasta.workflow.cwl/filter/outRemoved"
                        }, 
                        {
                            "source": "#preprocess-fasta.workflow.cwl/stats", 
                            "id": "#preprocess-fasta.workflow.cwl/filter/stats"
                        }
                    ], 
                    "out": [
                        "#preprocess-fasta.workflow.cwl/filter/passed", 
                        "#preprocess-fasta.workflow.cwl/filter/removed"
                    ], 
                    "id": "#preprocess-fasta.workflow.cwl/filter"
                }
            ], 
            "id": "#preprocess-fasta.workflow.cwl"
        }, 
        {
            "class": "Workflow", 
        ...
        }, 
        {
            ...
            "outputs": [
                ...
                {
                    "type": "File", 
                    "outputSource": "#main/orgScreen/passed", 
                    "id": "#main/orgScreenPassed"
                }, 
                {
                    "type": "File", 
            ...
            "steps": [
                ...
                {
                    "run": "#organism-screening.workflow.cwl", 
                    "in": [
                        {
                            "source": "#main/indexDir", 
                            "id": "#main/orgScreen/indexDir"
                        }, 
                        {
                            "source": "#main/indexName", 
                            "id": "#main/orgScreen/indexName"
                        }, 
                        {
                            "source": "#main/jobid", 
                            "id": "#main/orgScreen/jobid"
                        }, 
                        {
                            "source": "#main/dereplication/passed", 
                            "id": "#main/orgScreen/sequences"
                        }
                    ], 
                    "out": [
                        "#main/orgScreen/passed"
                    ], 
                    "id": "#main/orgScreen"
                }, 
                {
                    "run": "#preprocess-fasta.workflow.cwl", 
                    "in": [
                        {
                            "source": "#main/deviation", 
                            "id": "#main/preProcess/deviation"
                        }, 
                        {
                            "source": "#main/filterAmbig", 
                            "id": "#main/preProcess/filterAmbig"
                        }, 
                        {
                            "source": "#main/filterLn", 
                            "id": "#main/preProcess/filterLn"
                        }, 
                        {
                            "source": "#main/jobid", 
                        ...
                        {
                            "source": "#main/maxAmbig", 
                            "id": "#main/preProcess/maxAmbig"
                        }, 
                        {
                        ...
                        {
                            "source": "#main/qcBasic/seqStatFile", 
                            "id": "#main/preProcess/stats"
                        }
                    ], 
                    "out": [
