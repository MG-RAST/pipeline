    ...
    "$graph": [
        ...
        }, 
        {
            ...
            "inputs": [
                {
                    ...
                    "id": "#assembly_coverage.tool.cwl/outName"
                }, 
                {
                    "type": "File", 
                    "format": [
                        "#assembly_coverage.tool.cwl/sequences/FileFormats.cv.yamlfasta", 
                        "#assembly_coverage.tool.cwl/sequences/FileFormats.cv.yamlfastq"
                    ], 
                    "inputBinding": {
                        "prefix": "--input"
                    }, 
                    "id": "#assembly_coverage.tool.cwl/sequences"
                }
            ], 
            "baseCommand": [
            ...
            "outputs": [
                {
                    "type": "stderr", 
                    "id": "#assembly_coverage.tool.cwl/error"
                }, 
                {
                    "type": "stdout", 
                    "id": "#assembly_coverage.tool.cwl/info"
                }, 
                {
                    "type": "File", 
                    "outputBinding": {
                    ...
                    "id": "#assembly_coverage.tool.cwl/output"
                }
            ], 
            "id": "#assembly_coverage.tool.cwl"
        }, 
        {
            "class": "CommandLineTool", 
            "label": "BLAT", 
        ...
        }, 
        {
            ...
            "outputs": [
                {
                    "type": "File", 
                    "outputSource": "#main/qcAssemble/assemblyCoverage", 
                    "id": "#main/assemblyCoverage"
                }, 
                {
                    "type": "File", 
                ...
                {
                    "type": "File", 
                    "outputSource": "#main/qcAssemble/qcStatFile", 
                    "id": "#main/qcStatOut"
                }, 
                {
                    "type": "File", 
                    "outputSource": "#main/qcAssemble/qcSummaryFile", 
                ...
                {
                    "type": "File", 
                    "outputSource": "#main/qcAssemble/seqBinFile", 
                    "id": "#main/seqBinOut"
                }, 
                {
                    "type": "File", 
                    "outputSource": "#main/qcAssemble/seqStatFile", 
                    "id": "#main/seqStatOut"
                }, 
                {
                    "type": "File", 
            ...
            "steps": [
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#main/qcAssemble/assemblyCoverage", 
                            "id": "#main/abundance/coverage"
                        }, 
                        {
                            "source": [
                ...
                {
                    "run": "#qc-assembled.workflow.cwl", 
                    "in": [
                        {
                            "source": "#main/jobid", 
                            "id": "#main/qcAssemble/jobid"
                        }, 
                        {
                            "valueFrom": "${ return [6, 15]; }", 
                            "id": "#main/qcAssemble/kmerLength"
                        }, 
                        {
                            "source": "#main/sequences", 
                            "id": "#main/qcAssemble/sequences"
                        }
                    ], 
                    "out": [
                        "#main/qcAssemble/assemblyCoverage", 
                        "#main/qcAssemble/seqStatFile", 
                        "#main/qcAssemble/seqBinFile", 
                        "#main/qcAssemble/qcStatFile", 
                        "#main/qcAssemble/qcSummaryFile"
                    ], 
                    "id": "#main/qcAssemble"
                }, 
                {
        ...
        }, 
        {
            ...
            "inputs": [
                {
                    "type": "string", 
                    "id": "#qc-assembled.workflow.cwl/jobid"
                }, 
                {
                    "type": [
                        "null", 
                    ...
                    "id": "#qc-assembled.workflow.cwl/kmerLength"
                }, 
                {
                    "type": "File", 
                    "id": "#qc-assembled.workflow.cwl/sequences"
                }
            ], 
            "outputs": [
                {
                    "type": "File", 
                    "outputSource": "#qc-assembled.workflow.cwl/coverage/output", 
                    "id": "#qc-assembled.workflow.cwl/assemblyCoverage"
                }, 
                {
                    "type": "File", 
                    "outputSource": "#qc-assembled.workflow.cwl/formatQcStats/stats", 
                    "id": "#qc-assembled.workflow.cwl/qcStatFile"
                }, 
                {
                    "type": "File", 
                    "outputSource": "#qc-assembled.workflow.cwl/formatQcStats/summary", 
                    "id": "#qc-assembled.workflow.cwl/qcSummaryFile"
                }, 
                {
                    "type": "File", 
                    "outputSource": "#qc-assembled.workflow.cwl/formatSequenceStats/bins", 
                    "id": "#qc-assembled.workflow.cwl/seqBinFile"
                }, 
                {
                    "type": "File", 
                    "outputSource": "#qc-assembled.workflow.cwl/formatSequenceStats/stats", 
                    "id": "#qc-assembled.workflow.cwl/seqStatFile"
                }
            ], 
            "steps": [
                {
                    "run": "#assembly_coverage.tool.cwl", 
                    "in": [
                        {
                            "source": "#qc-assembled.workflow.cwl/jobid", 
                            "valueFrom": "$(self).075.assembly.coverage", 
                            "id": "#qc-assembled.workflow.cwl/coverage/outName"
                        }, 
                        {
                            "source": "#qc-assembled.workflow.cwl/sequences", 
                            "id": "#qc-assembled.workflow.cwl/coverage/sequences"
                        }
                    ], 
                    "out": [
                        "#qc-assembled.workflow.cwl/coverage/output"
                    ], 
                    "id": "#qc-assembled.workflow.cwl/coverage"
                }, 
                {
                    "run": "#format_qc_stats.tool.cwl", 
                    "in": [
                        {
                            "source": "#qc-assembled.workflow.cwl/coverage/output", 
                            "id": "#qc-assembled.workflow.cwl/formatQcStats/coverage"
                        }, 
                        {
                            "source": "#qc-assembled.workflow.cwl/kmer/stats", 
                            "id": "#qc-assembled.workflow.cwl/formatQcStats/kmer"
                        }, 
                        {
                            "source": "#qc-assembled.workflow.cwl/jobid", 
                            "valueFrom": "$(self).075.qc", 
                            "id": "#qc-assembled.workflow.cwl/formatQcStats/outPrefix"
                        }
                    ], 
                    "out": [
                        "#qc-assembled.workflow.cwl/formatQcStats/stats", 
                        "#qc-assembled.workflow.cwl/formatQcStats/summary"
                    ], 
                    "id": "#qc-assembled.workflow.cwl/formatQcStats"
                }, 
                {
                    ...
                    "in": [
                        {
                            "source": "#qc-assembled.workflow.cwl/jobid", 
                            "valueFrom": "$(self).075.qc", 
                            "id": "#qc-assembled.workflow.cwl/formatSequenceStats/output_prefix"
                        }, 
                        {
                            "source": "#qc-assembled.workflow.cwl/sequenceStats/gcBinOut", 
                            "id": "#qc-assembled.workflow.cwl/formatSequenceStats/sequence_gc"
                        }, 
                        {
                            "source": "#qc-assembled.workflow.cwl/sequenceStats/lenBinOut", 
                            "id": "#qc-assembled.workflow.cwl/formatSequenceStats/sequence_lengths"
                        }, 
                        {
                            "source": "#qc-assembled.workflow.cwl/sequenceStats/statOut", 
                            "id": "#qc-assembled.workflow.cwl/formatSequenceStats/sequence_stats"
                        }
                    ], 
                    "out": [
                        "#qc-assembled.workflow.cwl/formatSequenceStats/stats", 
                        "#qc-assembled.workflow.cwl/formatSequenceStats/bins"
                    ], 
                    "id": "#qc-assembled.workflow.cwl/formatSequenceStats"
                }, 
                {
                    "run": "#kmer-tool.tool.cwl", 
                    "scatter": "#qc-assembled.workflow.cwl/kmer/length", 
                    "scatterMethod": "dotproduct", 
                    "in": [
                        {
                            "valueFrom": "histo", 
                            "id": "#qc-assembled.workflow.cwl/kmer/format"
                        }, 
                        {
                            "source": "#qc-assembled.workflow.cwl/kmerLength", 
                            "id": "#qc-assembled.workflow.cwl/kmer/length"
                        }, 
                        {
                            "source": "#qc-assembled.workflow.cwl/jobid", 
                            "valueFrom": "$(self).075", 
                            "id": "#qc-assembled.workflow.cwl/kmer/prefix"
                        }, 
                        {
                            "source": "#qc-assembled.workflow.cwl/sequences", 
                            "id": "#qc-assembled.workflow.cwl/kmer/sequences"
                        }
                    ], 
                    "out": [
                        "#qc-assembled.workflow.cwl/kmer/stats"
                    ], 
                    "id": "#qc-assembled.workflow.cwl/kmer"
                }, 
                {
                    ...
                    "in": [
                        {
                            ...
                            "id": "#qc-assembled.workflow.cwl/sequenceStats/gcBin"
                        }, 
                        {
                            "source": "#qc-assembled.workflow.cwl/jobid", 
                            "valueFrom": "$(self).075.length.bin", 
                            "id": "#qc-assembled.workflow.cwl/sequenceStats/lenBin"
                        }, 
                        {
                            "source": "#qc-assembled.workflow.cwl/jobid", 
                            "valueFrom": "$(self).075.seq.stats", 
                            "id": "#qc-assembled.workflow.cwl/sequenceStats/outName"
                        }, 
                        {
                            "source": "#qc-assembled.workflow.cwl/sequences", 
                            "id": "#qc-assembled.workflow.cwl/sequenceStats/sequences"
                        }
                    ], 
                    "out": [
                        "#qc-assembled.workflow.cwl/sequenceStats/statOut", 
                        "#qc-assembled.workflow.cwl/sequenceStats/lenBinOut", 
                        "#qc-assembled.workflow.cwl/sequenceStats/gcBinOut"
                    ], 
                    "id": "#qc-assembled.workflow.cwl/sequenceStats"
                }
            ], 
            "id": "#qc-assembled.workflow.cwl"
        }, 
        {
            "class": "Workflow", 
